...
namespace MegaTrade.Common.Extensions
{
    public static class ListExtensions
    {
        ...
        {
            byte[] bytes = new byte[source.Count * sizeof(double)];
        ...
        public static IList<T> DecompressBy<T>(this IList<T> source, ISecurity bySecurity) where T : struct => bySecurity.Decompress(source, DecompressMethodWithDef.Default);
    }
}
