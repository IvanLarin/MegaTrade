...
/// <para>Перегрузки <c>Signal</c> рисуют полупрозрачные вертикальные полосы. Благодаря полупрозрачности цвета могут смешиваться для придания дополнительной семантики.</para>
...
public interface IPaint
{
    ...
    /// <summary>
    /// Рисует одну или несколько горизонтальных границ.
    /// </summary>
